...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cover', models.ImageField(blank=True, upload_to='cover/books/title', validators=[app.models.Cover.validate_image], verbose_name='Изображения')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photoPreview', models.ImageField(null=True, upload_to='cover', validators=[app.models.Book.validate_image], verbose_name='Изображения')),
                ('bookFile', models.FileField(null=True, upload_to='books', verbose_name='Файл с книгой')),
                ('author', models.ForeignKey(max_length=100, on_delete=django.db.models.deletion.CASCADE, to='app.author', verbose_name='Автор')),
            ],
            options={
                'verbose_name': 'Книга',
